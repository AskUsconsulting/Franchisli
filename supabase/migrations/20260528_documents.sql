...
- Notify guest if wait will exceed standard',
  ...
  ('ba000001-0000-0000-0000-000000000006',
  ...
  ('ba000001-0000-0000-0000-000000000007',
  ...
  ('ba000001-0000-0000-0000-000000000008',
...
INSERT INTO documents (id, title, description, category_id, doc_type, version, status, requires_acknowledgment, created_by, created_at, updated_at) VALUES
  ('ba000001-0000-0000-0000-000000000009',
  ...
  ('ba000001-0000-0000-0000-00000000000A',
   ...
   NOW() - INTERVAL '60 days', NOW() - INTERVAL '60 days'),
  ('ba000001-0000-0000-0000-00000000000B',
   ...
   NOW() - INTERVAL '60 days', NOW() - INTERVAL '60 days'),
  ('ba000001-0000-0000-0000-00000000000C',
...
-- Policies
INSERT INTO documents (id, title, description, category_id, doc_type, version, status, requires_acknowledgment, created_by, created_at, updated_at) VALUES
  ('ba000001-0000-0000-0000-00000000000D',
  ...
  ('ba000001-0000-0000-0000-00000000000E',
  ...
  ('ba000001-0000-0000-0000-00000000000F',
  ...
  ('ba000001-0000-0000-0000-000000000010',
...
INSERT INTO policy_acknowledgments (document_id, location_id, acknowledged_by, acknowledged_at) VALUES
  ('ba000001-0000-0000-0000-00000000000E', 'a0000000-0000-0000-0000-000000000001', 'Downtown Manager', NOW() - INTERVAL '25 days'),
  ('ba000001-0000-0000-0000-00000000000E', 'a0000000-0000-0000-0000-000000000002', 'Buckhead Manager', NOW() - INTERVAL '24 days'),
  ('ba000001-0000-0000-0000-00000000000E', 'a0000000-0000-0000-0000-000000000003', 'Midtown Manager', NOW() - INTERVAL '23 days'),
  ('ba000001-0000-0000-0000-00000000000E', 'a0000000-0000-0000-0000-000000000005', 'Marietta Manager', NOW() - INTERVAL '22 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000001', 'Downtown Manager', NOW() - INTERVAL '80 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000002', 'Buckhead Manager', NOW() - INTERVAL '79 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000003', 'Midtown Manager', NOW() - INTERVAL '78 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000004', 'Decatur Manager', NOW() - INTERVAL '77 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000005', 'Marietta Manager', NOW() - INTERVAL '76 days'),
  ('ba000001-0000-0000-0000-00000000000F', 'a0000000-0000-0000-0000-000000000006', 'Smyrna Manager', NOW() - INTERVAL '75 days'),
  ('ba000001-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', 'Downtown Manager', NOW() - INTERVAL '20 days'),
  ('ba000001-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000002', 'Buckhead Manager', NOW() - INTERVAL '19 days'),
  ('ba000001-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000004', 'Decatur Manager', NOW() - INTERVAL '18 days'),
  ('ba000001-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000006', 'Smyrna Manager', NOW() - INTERVAL '17 days');
